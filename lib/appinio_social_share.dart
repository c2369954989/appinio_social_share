...
class AppinioSocialShare {
  ...
  Future<String> shareToWeChat(String message, {String? filePath}) {
    return AppinioSocialSharePlatform.instance.shareToWeChat(message, filePath: filePath);
  }

  Future<String> shareToQq(String message, {String? filePath}) {
    return AppinioSocialSharePlatform.instance.shareToQq(message, filePath: filePath);
  }

  Future<String> shareToLine(String message, {String? filePath}) {
    return AppinioSocialSharePlatform.instance.shareToLine(message, filePath: filePath);
  }
  ...
  Future<String> shareToDiscord(String message, {String? filePath}) {
    return AppinioSocialSharePlatform.instance.shareToDiscrod(message, filePath: filePath);
  }

  Future<String> shareToInstagramDirect(String message, {String? filePath}) {
    return AppinioSocialSharePlatform.instance.shareToInstagramDirect(message, filePath: filePath);
  }
  ...
  Future<String> shareToInstagramStory({String? stickerImage, String? backgroundImage, String? backgroundVideo, String? backgroundTopColor, String? backgroundBottomColor, String? attributionURL}) {
  ...
  Future<String> shareToFacebookStory(String appId, {String? stickerImage, String? backgroundImage, String? backgroundVideo, String? backgroundTopColor, String? backgroundBottomColor, String? attributionURL}) {
  ...
  Future<String> shareToTiktokPost(String videoFile) {
    if (Platform.isAndroid) {
      return shareToTiktokStatus(videoFile);
    }
