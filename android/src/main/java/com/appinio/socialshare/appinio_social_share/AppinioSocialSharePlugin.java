  ...
  public String decideApp(@NonNull MethodCall call, @NonNull Result result) {
    ...
    switch (call.method) {
      ...
      case INSTAGRAM_DIRECT:
        return socialShareUtil.shareFileAndTextToInstagram(imagePath, message, activeContext);
      case INSTAGRAM_FEED:
      ...
      case WECHAT:
        return socialShareUtil.shareToWeChat(imagePath, activeContext, message);
      case QQ:
