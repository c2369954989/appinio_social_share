...
class _MyAppState extends State<MyApp> {
        ...
        home: Scaffold(
          body: Column(
            children: [
              ...
              ElevatedButton(
                child: const Text("shareToInstagram"),
                onPressed: () async {
  ...
  shareToFacebook() async {
    ...
    String response = await appinioSocialShare.shareToFacebook(
      'my first test share message',
      "/storage/emulated/0/DCIM/Camera/IMG_20230303_115155.jpg");
    print(response);
  ...
  shareToTwitter() async {
    // String response = await appinioSocialShare.shareToFacebookStory('1312443126001084');
    String response = await appinioSocialShare.shareToTwitter(
      'my first test share message',
      filePath: "/storage/emulated/0/DCIM/Camera/IMG_20230303_115155.jpg");
    print(response);
    // await appinioSocialShare.shareToWhatsapp(message, filePath: filePath);
  }
  ...
  shareToWeChat() async {
    // String response = await appinioSocialShare.shareToFacebookStory('1312443126001084');
    String response = await appinioSocialShare.shareToWeChat(
      'my first test share message',
      filePath: "/storage/emulated/0/DCIM/Camera/IMG_20230303_115155.jpg");
    print(response);
    // await appinioSocialShare.shareToWhatsapp(message, filePath: filePath);
  ...
  shareToQq() async {
    // String response = await appinioSocialShare.shareToFacebookStory('1312443126001084');
    String response = await appinioSocialShare.shareToQq(
      'my first test share message',
      filePath: "/storage/emulated/0/DCIM/Camera/IMG_20230303_115155.jpg");
    print(response);
    // await appinioSocialShare.shareToWhatsapp(message, filePath: filePath);
  ...
  shareToLine() async {
    // String response = await appinioSocialShare.shareToFacebookStory('1312443126001084');
    String response = await appinioSocialShare.shareToLine(
      'my first test share message',
      filePath: "/storage/emulated/0/DCIM/Camera/IMG_20230303_115155.jpg");
    print(response);
    // await appinioSocialShare.shareToWhatsapp(message, filePath: filePath);
  ...
  shareToDiscord() async {
    // String response = await appinioSocialShare.shareToFacebookStory('1312443126001084');
    String response = await appinioSocialShare.shareToDiscord(
      'my first test share message',
      filePath: "/storage/emulated/0/DCIM/Camera/IMG_20230303_115155.jpg");
    print(response);
    // await appinioSocialShare.shareToWhatsapp(message, filePath: filePath);
  ...
  shareToInstagram() async {
    // String response = await appinioSocialShare.shareToFacebookStory('1312443126001084');
    String response = await appinioSocialShare.shareToInstagramDirect(
      'my first test share message',
      filePath: "/storage/emulated/0/DCIM/Camera/IMG_20230303_115155.jpg");
    print(response);
    // await appinioSocialShare.shareToWhatsapp(message, filePath: filePath);
